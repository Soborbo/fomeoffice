...
export function getLocalBusinessSchema() {
  return {
    ...
    "description": "Professional car and van valeting service in Southmead, Bristol. Offering car wash, van wash, caravan cleaning, car detailing, and full valet packages at affordable prices.",
    "url": SITE_URL,
    ...
    "image": [
      ...
      `${SITE_URL}/images/Bristol-Car-Wash-logo.webp`,
    ],
    "logo": {
      "@type": "ImageObject",
      "url": `${SITE_URL}/images/Bristol-Car-Wash-logo.webp`,
      "width": 200,
      "height": 80,
    },
    "address": {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        {
          "@type": "Offer",
          "itemOffered": { "@type": "Service", "name": "Wash & Wax", "description": "Snow foam wash, hand dry, windows inside & out, tyre dressing, door line cleaning" },
          "price": "10",
          "priceCurrency": "GBP",
        },
        {
          "@type": "Offer",
          "itemOffered": { "@type": "Service", "name": "Bronze Wash", "description": "Everything in Wash & Wax plus hoover (seats, carpets, boot)" },
          "price": "20",
          "priceCurrency": "GBP",
        },
        {
          "@type": "Offer",
          "itemOffered": { "@type": "Service", "name": "Silver Wash", "description": "Everything in Bronze Wash plus all plastics cleaned & treated with premium Autosmart materials" },
          "price": "25",
          "priceCurrency": "GBP",
        },
        {
          "@type": "Offer",
          "itemOffered": { "@type": "Service", "name": "Wash & Polish", "description": "Full exterior wash plus hand polish (cream polish to remove minor scratches and restore shine), outside only" },
          "price": "40",
          "priceCurrency": "GBP",
        },
        {
          "@type": "Offer",
          "itemOffered": { "@type": "Service", "name": "Special Offer", "description": "Wash, dry & polish, hoover (seats, carpets, boot), windows inside & out, dashboard & interior polish" },
          "price": "35",
          "priceCurrency": "GBP",
        },
        {
          "@type": "Offer",
          "itemOffered": { "@type": "Service", "name": "Full Valet", "description": "Full wash, interior & exterior cleaned with specialist chemicals, all surfaces treated, engine clean available" },
          "price": "60",
          "priceCurrency": "GBP",
        },
        {
...
export function getOrganizationSchema() {
  return {
    ...
    "legalName": LEGAL_NAME,
    "url": SITE_URL,
    "logo": `${SITE_URL}/images/Bristol-Car-Wash-logo.webp`,
    "foundingDate": FOUNDING_DATE,
    "contactPoint": {
      "@type": "ContactPoint",
      "telephone": PHONE_INTL,
