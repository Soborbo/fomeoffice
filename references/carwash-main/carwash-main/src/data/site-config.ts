...
export const SITE_URL = 'https://bristolcarwash.co.uk';
export const BUSINESS_NAME = 'Painless Car & Van Wash';
...
export const EMAIL = 'hello@bristolcarwash.co.uk';
export const BOOKING_EMAIL = 'bookings@bristolcarwash.co.uk';
export const OFFICE_EMAIL = 'office@bristolcarwash.co.uk';
...
export const HOURS = {
  ...
  headerDisplay: 'Mon-Sat: 9am-7pm | Sun: 9am-5pm',
};
